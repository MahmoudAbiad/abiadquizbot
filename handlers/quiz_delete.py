...
المعروضة بكل الشاشات أعلاه، فلا يوجد جدول كاش منفصل يحتاج تنظيفاً يدوياً.
بفضل ON DELETE CASCADE بقاعدة البيانات، يُحذف معه تلقائياً كل ما يرتبط به:
تصويتات اللايك/الديسلايك، النقاط ولوحة المتصدرين، عناصر مفضلة كل الطلاب،
والملاحظات/الشكاوى المرتبطة به.
