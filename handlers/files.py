...
question counting, text extraction, and background quiz generation.
"""
...
from constants import (
    ERROR_PDF_READ_FAILED, ERROR_NO_TEXT_EXTRACTED, 
    ERROR_NO_QUESTIONS_GENERATED, ERROR_INSUFFICIENT_POINTS, 
...
async def _generate_and_start_quiz(
    ...
    try:
        ...
        if corrupted_questions:
            ...
            # 💡 التعديل الجوهري هنا: استيراد الدالة محلياً لمنع الـ Circular Import
...
# لضمان التوافق مع التسميات المستوردة في __init__.py أو main.py
files_router = router