...
class AdminState(StatesGroup):
    ...
    waiting_for_direct_message_mode = State()
...
async def render_admin_dashboard(event, state: FSMContext = None):
    ...
    text = (
        ...
        "━━━━━━━━━━━━━━━━━━\n\n"
        "اختر القسم المطلوب لتنفيذ العملية بسرعة:\n\n"
        "✉️ <b>التواصل:</b> إرسال رسالة فردية أو جماعية\n"
        "👥 <b>المستخدمون:</b> البحث واستعراض السجل\n"
        "📊 <b>المتابعة:</b> النشاط والإحصائيات والتحليلات\n"
        "📥 <b>البيانات:</b> تصدير سجل الطلاب"
    )
