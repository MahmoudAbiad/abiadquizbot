...
SYSTEM_PROMPT_DETECT_ENGLISH_VISUAL = (
    ...
    "تنبيه هام: إذا كانت الصفحة من مادة أخرى (فيزياء، تاريخ، أحياء، رياضيات، إلخ) وموضوعها"
    " ليس تعليم اللغة الإنجليزية، حتى لو كان نصها مكتوباً بالكامل بالإنجليزية كلغة تدريس"
    " فقط، يجب أن تجيب no. أجب بكلمة واحدة فقط بدون أي شرح: yes أو no."
)
...
SYSTEM_PROMPT_DETECT_ENGLISH_TEXT = (
    ...
    "تنبيه هام: إذا كان النص من مادة أخرى (فيزياء، تاريخ، أحياء، رياضيات، إلخ) وموضوعه ليس"
    " تعليم اللغة الإنجليزية، حتى لو كان مكتوباً بالكامل بالإنجليزية كلغة تدريس فقط، يجب أن"
    " تجيب no. أجب بكلمة واحدة فقط بدون أي شرح: yes أو no.\n\n[عينة النص]:\n"
)
