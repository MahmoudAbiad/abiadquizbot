...
[تنسيق الإخراج]:
يجب أن يكون الإخراج بصيغة JSON مصفوفة (Array of Objects) فقط، دون أي مقدمات أو مؤخرات أو علامات مقتبسة خارج الـ JSON (خام تماماً)، ليتسنى للنظام قراءتها برمجياً فوراً. التزم بالهيكل التالي:

[
  {
    "question": "نص السؤال هنا (أقل من 299 حرف)",
    "options": ["الخيار الأول", "الخيار الثاني", "الخيار الثالث"],
    "correct_option_index": 0, 
    "hint": "التلميح هنا",
    "explanation": "الشرح هنا (أقل من 200 حرف)"
  }
]
"""
