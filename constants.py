...
4. يجب أن تكون جميع الأسئلة باللغة العربية الفصحى، وأن تكون واضحة ومباشرة.
5. يجب أن تكون جميع الأسئلة من نوع اختيار من متعدد (Multiple Choice) مع {option_count} خيارات لكل سؤال.
6. يجب أن تكون جميع الأسئلة دقيقة وموضوعية، ولا تحتوي على أي تحيز أو آراء شخصية.
7. يجب أن تكون جميع الأسئلة قابلة للتقييم بشكل موضوعي، بحيث يمكن تحديد الإجابة الصحيحة لكل سؤال دون أي غموض.
8.يجب ان لا يتعدى طول السؤال الواحد 299 حرف , ويجب ان لا يتعدى طول الجواب الواحد 99 حرفا
