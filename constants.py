...
# 🆕 ==================== English Content Detection Prompts (اقتراح ترجمة الأسئلة) ====================
# فحص سريع بنفس آلية/نموذج فحص الرياضيات (عينة واحدة فقط: أول صفحة/صورة أو عينة نصية):
# هل المحتوى مكتوب أساساً باللغة الإنجليزية؟ يُستخدم لعرض خيار "ترجمة الأسئلة" على الطالب
# قبل بدء التوليد الفعلي (وليس أثناءه، لأن القرار هنا يتطلب تفاعل الطالب عبر كيبورد).
SYSTEM_PROMPT_DETECT_ENGLISH_VISUAL = (
    "افحص هذه الصفحة/الصورة بدقة. هل النص الأساسي المكتوب فيها بلغة إنجليزية (وليس عربية"
    " أو أي لغة أخرى)؟ إذا كانت الصفحة تحتوي بشكل أساسي على معادلات رياضية بدون نص لغوي"
    " واضح، أجب no. أجب بكلمة واحدة فقط بدون أي شرح: yes أو no."
)

SYSTEM_PROMPT_DETECT_ENGLISH_TEXT = (
    "افحص عينة النص التالية بدقة. هل هذا النص مكتوب أساساً باللغة الإنجليزية (وليس عربية أو"
    " أي لغة أخرى)؟ أجب بكلمة واحدة فقط بدون أي شرح: yes أو no.\n\n[عينة النص]:\n"
)
...
MSG_ENGLISH_CONTENT_DETECTED = (
    "🌐 <b>لاحظنا أن محتوى الملف/الصورة مكتوب باللغة الإنجليزية!</b>\n\n"
