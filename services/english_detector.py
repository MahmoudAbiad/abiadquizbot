...
"""
⚠️ DEPRECATED (غير مستخدم حالياً): تم استبدال هذا الموديول بـ
services/subject_classifier.py (فحص موحّد باستدعاء AI واحد بدل استدعاءين
منفصلين). أُبقي هذا الملف كمرجع تاريخي فقط ولا يُستورَد من أي مكان بالكود -
راجع services/subject_classifier.py لأي تعديل مستقبلي على منطق الفحص.
==============================================================================
